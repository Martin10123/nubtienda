...
<template>
    <ul
        class="absolute right-2 top-20 bg-white shadow-lg rounded-lg p-4 w-[23.5rem] duration-300 lg:relative lg:top-0 lg:right-0 lg:w-auto lg:p-0 lg:shadow-none lg:flex lg:items-center lg:gap-4"
        :class="{
